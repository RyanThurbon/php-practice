...
<body>
	<div class="flex min-h-screen">
		<div class="flex mx-auto items-center">
			<form class="flex flex-col gap-y-4 border rounded-lg p-4" method="post" action="includes/userRegister.inc.php">
				...
				<div class="flex flex-col gap-y-2">
					...
					<input name="email" type="email" placeholder="Email" class="border rounded-md p-2" required />
